...
const FileContractInfo = {
    abi: [
        ...
        "function sendEmail(address toAddress, bool isEncryption, bytes memory uuid,bytes memory title,bytes calldata encryptData, bytes memory fileUuid) public payable",
